...
class Drawing
{
     ...
     *
     * @param int $pValue Value in pixels
     * @param \Drupal\cloud_system\PHPExcel\Style\Font $pDefaultFont Default font of the workbook
     *
     * @return int Value in cell dimension
     */
    public static function pixelsToCellDimension($pValue, \Drupal\cloud_system\PHPExcel\Style\Font $pDefaultFont)
    {
        // Font name and size
     ...
     * @return int Value in pixels
     */
    public static function cellDimensionToPixels($pValue, \Drupal\cloud_system\PHPExcel\Style\Font $pDefaultFont)
    {
        // Font name and size
        $name = $pDefaultFont->getName();
        $size = $pDefaultFont->getSize();
