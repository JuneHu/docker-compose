...
use Drupal\cloud_system\PHPExcel\Comment;
...
class Comments extends WriterPart
{
     ...
     */
    public function writeComments(\Drupal\cloud_system\PHPExcel\Worksheet $pWorksheet)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @return string XML Output
     */
    public function writeVMLComments(\Drupal\cloud_system\PHPExcel\Worksheet $pWorksheet)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
