...
namespace Drupal\cloud_system\PHPExcel\Shared\OLE\PPS;
...
use Drupal\cloud_system\PHPExcel\Shared\OLE\PPS;
...
class Root extends PPS
{
    ...
    {
        $this->_tempDir = \Drupal\cloud_system\PHPExcel\Shared\File::sysGetTempDir();
    ...
    public function save($filename)
    {
        ...
        if (is_resource($filename)) {
            ...
            if ($this->tempDirectory === null) {
                $this->tempDirectory = \Drupal\cloud_system\PHPExcel\Shared\File::sysGetTempDir();
            }
    ...
    /**
     * Saving big data (PPS's with data bigger than \Drupal\cloud_system\PHPExcel\Shared\OLE::OLE_DATA_SIZE_SMALL).
     *
     * @param int $iStBlk
    ...
    /**
     * get small data (PPS's with data smaller than \Drupal\cloud_system\PHPExcel\Shared\OLE::OLE_DATA_SIZE_SMALL).
     *
     * @param array &$raList Reference to array of PPS's
     */
