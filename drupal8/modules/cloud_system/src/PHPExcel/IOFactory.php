...
class IOFactory
{
    ...
    private static $searchLocations = [
        ['type' => 'IWriter', 'path' => 'PHPExcel/Writer/{0}.php', 'class' => '\\Drupal\\cloud_system\\PHPExcel\\Writer\\{0}'],
        ['type' => 'IReader', 'path' => 'PHPExcel/Reader/{0}.php', 'class' => '\\Drupal\\cloud_system\\PHPExcel\\Reader\\{0}'],
    ];
