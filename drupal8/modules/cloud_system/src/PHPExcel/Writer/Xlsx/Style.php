...
class Style extends WriterPart
{
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \Drupal\cloud_system\PHPExcel\Style $pStyle Style
     * @param Spreadsheet $spreadsheet Workbook
     *
     * @throws \Drupal\cloud_system\PHPExcel\Writer\Exception
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \Drupal\cloud_system\PHPExcel\Style $pStyle, Spreadsheet $spreadsheet)
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', 0);
     ...
     * @throws \Drupal\cloud_system\PHPExcel\Writer\Exception
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \Drupal\cloud_system\PHPExcel\Style $pStyle)
    {
        // dxf
     ...
     * @throws \Drupal\cloud_system\PHPExcel\Writer\Exception
     *
     * @return \Drupal\cloud_system\PHPExcel\Style[] All styles in PhpSpreadsheet
     */
    ...
    public function allFills(Spreadsheet $spreadsheet)
    {
        ...
        /** @var \Drupal\cloud_system\PHPExcel\Style $style */
