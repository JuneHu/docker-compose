...
namespace Drupal\cloud_system\PHPExcel\Writer\Xls;

use Drupal\cloud_system\PHPExcel\Cell;
use Drupal\cloud_system\PHPExcel\Cell\DataValidation;
...
use Drupal\cloud_system\PHPExcel\Shared\Xls;
use Drupal\cloud_system\PHPExcel\Style\Alignment;
use Drupal\cloud_system\PHPExcel\Style\Border;
use Drupal\cloud_system\PHPExcel\Style\Color;
use Drupal\cloud_system\PHPExcel\Style\Conditional;
use Drupal\cloud_system\PHPExcel\Style\Fill;
use Drupal\cloud_system\PHPExcel\Style\Protection;
use Drupal\cloud_system\PHPExcel\Worksheet\PageSetup;
use Drupal\cloud_system\PHPExcel\Worksheet\SheetView;
...
class Worksheet extends BIFFwriter
{
     ...
     * Formula parser.
     *
     * @var \Drupal\cloud_system\PHPExcel\Writer\Xls\Parser
     */
    private $parser;
     ...
     * Sheet object.
     *
     * @var \Drupal\cloud_system\PHPExcel\Worksheet
     */
    public $phpSheet;
     ...
     *
     * @var \Drupal\cloud_system\PHPExcel\Shared\Escher
     */
    private $escher;
     ...
     * @param \Drupal\cloud_system\PHPExcel\Worksheet $phpSheet
     */
...
//        if ($this->firstColumnIndex > 255) $this->firstColumnIndex = 255;
     ...
     *
     * @see \Drupal\cloud_system\PHPExcel\Writer\Xls\Workbook::storeWorkbook()
     */
    public function close()
    {
        ...
        if (($defaultWidth = $phpSheet->getDefaultColumnDimension()->getWidth()) < 0) {
            $defaultWidth = \Drupal\cloud_system\PHPExcel\Shared\Font::getDefaultColumnWidthByFont($phpSheet->getParent()->getDefaultStyle()->getFont());
        }
    ...
    private function writeBreaks()
    {
        ...
        foreach ($this->phpSheet->getBreaks() as $cell => $breakType) {
            ...
            switch ($breakType) {
                case \Drupal\cloud_system\PHPExcel\Worksheet::BREAK_COLUMN:
                    // Add to list of vertical breaks
                    $vbreaks[] = Cell::columnIndexFromString($coordinates[0]) - 1;
                    break;
                case \Drupal\cloud_system\PHPExcel\Worksheet::BREAK_ROW:
                    // Add to list of horizontal breaks
                    $hbreaks[] = $coordinates[1];
                    break;
                case \Drupal\cloud_system\PHPExcel\Worksheet::BREAK_NONE:
                default:
                    // Nothing to do
                    break;
            }
     ...
     * Get Escher object.
     *
     * @return \Drupal\cloud_system\PHPExcel\Shared\Escher
     */
     ...
     * Set Escher object.
     *
     * @param \Drupal\cloud_system\PHPExcel\Shared\Escher $pValue
     */
    public function setEscher(\Drupal\cloud_system\PHPExcel\Shared\Escher $pValue = null)
    {
        $this->escher = $pValue;
    }
    ...
    private function writeCFRule(Conditional $conditional)
    {
        ...
        if ($bFormatFont == 1) {
            ...
            switch ($conditional->getStyle()->getFont()->getUnderline()) {
                case \Drupal\cloud_system\PHPExcel\Style\Font::UNDERLINE_NONE:
                    $dataBlockFont .= pack('C', 0x00);
                    $fontUnderline = 0;
                    break;
                case \Drupal\cloud_system\PHPExcel\Style\Font::UNDERLINE_DOUBLE:
                    $dataBlockFont .= pack('C', 0x02);
                    $fontUnderline = 0;
                    break;
                case \Drupal\cloud_system\PHPExcel\Style\Font::UNDERLINE_DOUBLEACCOUNTING:
                    $dataBlockFont .= pack('C', 0x22);
                    $fontUnderline = 0;
                    break;
                case \Drupal\cloud_system\PHPExcel\Style\Font::UNDERLINE_SINGLE:
                    $dataBlockFont .= pack('C', 0x01);
                    $fontUnderline = 0;
                    break;
                case \Drupal\cloud_system\PHPExcel\Style\Font::UNDERLINE_SINGLEACCOUNTING:
