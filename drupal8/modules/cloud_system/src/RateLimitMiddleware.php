...
/**
 * @file
 * Contains \Drupal\cloud_system\RateLimitMiddleware.
 */
...
class RateLimitMiddleware implements HttpKernelInterface {
   ...
   *
   * @var \Drupal\cloud_system\RateLimitManagerInterface
   */
  protected $manager;
   ...
   * @param \Drupal\cloud_system\RateLimitManagerInterface $manager
