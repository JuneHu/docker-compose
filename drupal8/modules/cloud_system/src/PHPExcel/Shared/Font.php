...
namespace Drupal\cloud_system\PHPExcel\Shared;
...
class Font
{
     ...
     *
     * @param \Drupal\cloud_system\PHPExcel\Style\Font $font Font object
     * @param RichText|string $cellText Text to calculate width
     * @param int $rotation Rotation angle
     * @param \Drupal\cloud_system\PHPExcel\Style\Font|null $defaultFont Font object
     *
     * @return int Column width
     */
    public static function calculateColumnWidth(\Drupal\cloud_system\PHPExcel\Style\Font $font, $cellText = '', $rotation = 0, \Drupal\cloud_system\PHPExcel\Style\Font $defaultFont = null)
    {
     ...
     *
     * @param string $text
     * @param \Drupal\cloud_system\PHPExcel\Style\Font
     * @param int $rotation
     *
     ...
     * @return int
     */
    public static function getTextWidthPixelsExact($text, \Drupal\cloud_system\PHPExcel\Style\Font $font, $rotation = 0)
    {
     ...
     * @param \Drupal\cloud_system\PHPExcel\Style\Font $font
     * @param int $rotation
     *
     * @return int Text width in pixels (no padding added)
     */
    public static function getTextWidthPixelsApprox($columnText, \Drupal\cloud_system\PHPExcel\Style\Font $font, $rotation = 0)
    {
     ...
     *
     * @param \Drupal\cloud_system\PHPExcel\Style\Font $font The workbooks default font
     * @param bool $pPixels true = return column width in pixels, false = return in OOXML units
     *
     * @return mixed Column width
     */
    public static function getDefaultColumnWidthByFont(\Drupal\cloud_system\PHPExcel\Style\Font $font, $pPixels = false)
    {
     ...
     */
    public static function getDefaultRowHeightByFont(\Drupal\cloud_system\PHPExcel\Style\Font $font)
    {
        switch ($font->getName()) {
            case 'Arial':
                switch ($font->getSize()) {
