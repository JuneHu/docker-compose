...
namespace Drupal\cloud_system\PHPExcel;

use Drupal\cloud_system\PHPExcel\Collection\Memory;
...
class Settings
{
     ...
     *    e.g. \Drupal\cloud_system\PHPExcel\Settings::CHART_RENDERER_JPGRAPH
     ...
     *
     * @param string $libraryName Internal reference name of the library
     *     e.g. \Drupal\cloud_system\PHPExcel\Settings::PDF_RENDERER_TCPDF,
     *          \Drupal\cloud_system\PHPExcel\Settings::PDF_RENDERER_DOMPDF
     *       or \Drupal\cloud_system\PHPExcel\Settings::PDF_RENDERER_MPDF
     */
