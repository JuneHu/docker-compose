...
class Workbook extends BIFFwriter
{
     ...
     * XF Writers.
     *
     * @var \Drupal\cloud_system\PHPExcel\Writer\Xls\Xf[]
     */
    private $xfWriters = [];
     ...
     * Add a new XF writer.
     *
     * @param \Drupal\cloud_system\PHPExcel\Style
     ...
     */
    public function addFont(\Drupal\cloud_system\PHPExcel\Style\Font $font)
    {
     ...
     *
     * @param \Drupal\cloud_system\PHPExcel\Worksheet $sheet Worksheet name
    ...
    private function writeBoundSheet($sheet, $offset)
    {
        ...
        switch ($sheet->getSheetState()) {
            case \Drupal\cloud_system\PHPExcel\Worksheet::SHEETSTATE_VISIBLE:
                $ss = 0x00;
                break;
            case \Drupal\cloud_system\PHPExcel\Worksheet::SHEETSTATE_HIDDEN:
                $ss = 0x01;
                break;
            case \Drupal\cloud_system\PHPExcel\Worksheet::SHEETSTATE_VERYHIDDEN:
                $ss = 0x02;
                break;
            default:
                $ss = 0x00;
