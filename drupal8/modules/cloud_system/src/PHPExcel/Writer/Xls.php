...
use Drupal\cloud_system\PHPExcel\Shared\Escher;
use Drupal\cloud_system\PHPExcel\Shared\Escher\DgContainer;
use Drupal\cloud_system\PHPExcel\Shared\Escher\DgContainer\SpgrContainer;
use Drupal\cloud_system\PHPExcel\Shared\Escher\DgContainer\SpgrContainer\SpContainer;
use Drupal\cloud_system\PHPExcel\Shared\Escher\DggContainer;
use Drupal\cloud_system\PHPExcel\Shared\Escher\DggContainer\BstoreContainer;
use Drupal\cloud_system\PHPExcel\Shared\Escher\DggContainer\BstoreContainer\BSE;
use Drupal\cloud_system\PHPExcel\Shared\Escher\DggContainer\BstoreContainer\BSE\Blip;
use Drupal\cloud_system\PHPExcel\Shared\OLE;
use Drupal\cloud_system\PHPExcel\Shared\OLE\PPS\File;
use Drupal\cloud_system\PHPExcel\Shared\OLE\PPS\Root;
    ...
    private function buildWorksheetEschers()
    {
        ...
        foreach ($this->spreadsheet->getAllsheets() as $sheet) {
            ...
            foreach ($sheet->getDrawingCollection() as $drawing) {
                ...
                $twoAnchor = \Drupal\cloud_system\PHPExcel\Shared\Xls::oneAnchor2twoAnchor($sheet, $coordinates, $offsetX, $offsetY, $width, $height);
