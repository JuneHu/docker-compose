...
/**
 * @file
 * Contains \Drupal\cloud_system\Form\RateLimiterConfigForm.
 */
...
use Drupal\cloud_system\RateLimitManager;

/**
 * Rate Limiter configuration form.
 *
 * @package Drupal\cloud_system\Form
 */
class RateLimiterConfigForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['basic']['enable'] = [
      ...
      '#default_value' => $rate_limiter_config->get('rate_limiter_enable'),
    ];
    ...
    $form['basic']['requests'] = [
      ...
      '#default_value' => $rate_limiter_config->get('rate_limiter_requests'),
      '#required' => TRUE,
    ];
    ...
    $form['basic']['time_cap'] = [
      ...
      '#default_value' => $rate_limiter_config->get('rate_limiter_time_cap'),
      '#required' => TRUE,
    ];
    ...
    $form['basic']['message'] = [
      ...
      '#maxlength' => 255,
      '#size' => 100,
      '#default_value' => $rate_limiter_config->get('rate_limiter_message'),
    ];
    ...
    $form['access']['limiting_rule'] = [
      '#type' => 'radios',
      '#title' => $this->t("Rate limiting rule based on the device\'s user agent"),
      ...
      '#required' => TRUE,
      '#default_value' => $rate_limiter_config->get('rate_limiter_limiting_rule'),
    ];
    ...
    $form['access']['ip_configuration']['whitelist'] = [
      ...
      '#default_value' => unserialize($rate_limiter_config->get('rate_limiter_whitelist')),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config($this->configName)
      ->set('rate_limiter_enable', $form_state->getValue('enable'))
      ->set('rate_limiter_requests', $form_state->getValue('requests'))
      ->set('rate_limiter_time_cap', $form_state->getValue('time_cap'))
      ->set('rate_limiter_message', $form_state->getValue('message'))
      ->set('rate_limiter_limiting_rule', $form_state->getValue('limiting_rule'))
      ->set('rate_limiter_whitelist', serialize($form_state->getValue('whitelist')))
      ->save();
