...
use Drupal\cloud_system\PHPExcel\Chart\Axis;
use Drupal\cloud_system\PHPExcel\Chart\DataSeries;
use Drupal\cloud_system\PHPExcel\Chart\DataSeriesValues;
use Drupal\cloud_system\PHPExcel\Chart\GridLines;
use Drupal\cloud_system\PHPExcel\Chart\Layout;
use Drupal\cloud_system\PHPExcel\Chart\Legend;
use Drupal\cloud_system\PHPExcel\Chart\PlotArea;
use Drupal\cloud_system\PHPExcel\Chart\Title;
...
class Chart extends WriterPart
{
     ...
     */
    public function writeChart(\Drupal\cloud_system\PHPExcel\Chart $pChart, $calculateCellValues = true)
    {
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \Drupal\cloud_system\PHPExcel\Worksheet $pSheet
     ...
     * @throws WriterException
     */
    private function writePlotArea(XMLWriter $objWriter, \Drupal\cloud_system\PHPExcel\Worksheet $pSheet, PlotArea $plotArea, Title $xAxisLabel = null, Title $yAxisLabel = null, Axis $xAxis = null, Axis $yAxis = null, GridLines $majorGridlines = null, GridLines $minorGridlines = null)
    {
        if (is_null($plotArea)) {
            return;
        }
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \Drupal\cloud_system\PHPExcel\Chart\Layout $chartLayout Chart layout
     *
     * @throws WriterException
     */
     ...
     * @throws WriterException
     */
    private function writePlotGroup($plotGroup, $groupType, $objWriter, &$catIsMultiLevelSeries, &$valIsMultiLevelSeries, &$plotGroupingType, \Drupal\cloud_system\PHPExcel\Worksheet $pSheet)
    {
