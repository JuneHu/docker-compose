...
namespace Drupal\cloud_system\PHPExcel\Reader;
...
use Drupal\cloud_system\PHPExcel\NamedRange;
use Drupal\cloud_system\PHPExcel\RichText;
use Drupal\cloud_system\PHPExcel\Shared\CodePage;
use Drupal\cloud_system\PHPExcel\Shared\Date;
...
use Drupal\cloud_system\PHPExcel\Shared\OLERead;
        ...
        foreach ($this->sheets as $sheet) {
            ...
            foreach ($this->objs as $n => $obj) {
                ...
                if (isset($allSpContainers[$n + 1]) && is_object($allSpContainers[$n + 1])) {
                    ...
                    $width = \Drupal\cloud_system\PHPExcel\Shared\Xls::getDistanceX($this->phpSheet, $startColumn, $startOffsetX, $endColumn, $endOffsetX);
                    $height = \Drupal\cloud_system\PHPExcel\Shared\Xls::getDistanceY($this->phpSheet, $startRow, $startOffsetY, $endRow, $endOffsetY);

                    // calculate offsetX and offsetY of the shape
                    $offsetX = $startOffsetX * \Drupal\cloud_system\PHPExcel\Shared\Xls::sizeCol($this->phpSheet, $startColumn) / 1024;
                    $offsetY = $startOffsetY * \Drupal\cloud_system\PHPExcel\Shared\Xls::sizeRow($this->phpSheet, $startRow) / 256;
