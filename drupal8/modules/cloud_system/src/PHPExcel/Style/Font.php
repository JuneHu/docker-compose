...
namespace Drupal\cloud_system\PHPExcel\Style;
...
class Font extends Supervisor implements IComparable
{
     ...
     *            'bold'      => TRUE,
     *            'italic'    => FALSE,
     *            'underline' => \Drupal\cloud_system\PHPExcel\Style\Font::UNDERLINE_DOUBLE,
     *            'strike'    => FALSE,
     *            'color'     => array(
     *                'rgb' => '808080'
     *            )
     ...
     * Set Underline.
     *
     * @param string|bool $pValue \Drupal\cloud_system\PHPExcel\Style\Font underline type
