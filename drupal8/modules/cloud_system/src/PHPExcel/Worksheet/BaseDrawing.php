...
namespace Drupal\cloud_system\PHPExcel\Worksheet;

use Drupal\cloud_system\PHPExcel\Exception as PhpSpreadsheetException;
use Drupal\cloud_system\PHPExcel\IComparable;
...
class BaseDrawing implements IComparable
{
     ...
     * Get Worksheet.
     *
     * @return \Drupal\cloud_system\PHPExcel\Worksheet
     */
    ...
    public function setWorksheet(Worksheet $pValue = null, $pOverrideOld = false)
    {
        if (is_null($this->worksheet)) {
            // Add drawing to \Drupal\cloud_system\PHPExcel\Worksheet
            $this->worksheet = $pValue;
            $this->worksheet->getCell($this->coordinates);
            $this->worksheet->getDrawingCollection()->append($this);
        } else {
            if ($pOverrideOld) {
                // Remove drawing from old \Drupal\cloud_system\PHPExcel\Worksheet
                ...
                // Set new \Drupal\cloud_system\PHPExcel\Worksheet
                $this->setWorksheet($pValue);
            } else {
                throw new PhpSpreadsheetException("A Worksheet has already been assigned. Drawings can only exist on one \Drupal\cloud_system\PHPExcel\Worksheet.");
            }
        }
